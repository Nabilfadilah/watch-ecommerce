            ...
            <ul>
                {blogs.map((blog, index) => (
                    <li key={index} className='mb-4'>
                        ...
                        <Typography className='text-gray-600'>Publish by {blog.author}</Typography>

                        <div className='flex items-center mt-2'>
                            <FiMessageCircle size={20} />
                            <Typography className='text-gray-500 mr-5 ml-1'>{blog.comments}</Typography>

                            <RiThumbUpLine size={20} />
                            <Typography className='text-gray-500 mr-2 ml-2'>{blog.likes}</Typography>
                        </div>
                    </li>
                ))}
            </ul>
